...
if (isset($_GET['sort-category']) && $_GET['sort-category'] != 'catalog') {
	$args['tax_query'][] = [
		'taxonomy' => 'franchise-other',
		'field'    => 'slug',
...
if (isset($_GET['sort-investment']) && $_GET['sort-investment'] != 'catalog') {
	$args['tax_query'][] = [
		'taxonomy' => 'franchise-other',
		'field'    => 'slug',
		...
		<div class="franchises">
			<form class="sort-blocks" id="catalog-sort" method="GET">
				<div class="selector-wrap">
					<select class="filter-selector sort-popularity js-sort-category" name="sort-popularity">
						<?php
			...
			<!-- <div class="show-more js-show-more">Показать больше</div> -->
			<!-- </div> -->
